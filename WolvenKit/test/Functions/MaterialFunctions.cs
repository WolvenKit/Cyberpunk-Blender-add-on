...
namespace WolvenKit.RED4.MeshFile.Materials
{
    ...
    {
        public static void ExporMeshWithMaterials(Stream meshStream, string dependencyMasterDir, string _meshName, string outfile, bool isGLBinary = true, bool useAssetLib = true,bool copyTextures = false,EUncookExtension eUncookExtension = EUncookExtension.dds , bool LodFilter = true)
        {
            ...
            if (useAssetLib)
                ParseMaterialsAsAssetLib(meshStream, ref model, outDir, dependencyMasterDir, copyTextures,eUncookExtension);
