...
def CP77CollisionTriangleMeshJSONimport(sectorHashStr="", entryHashStr="", project_raw_dir=""):
    ...
    mesh_obj[
        "physics_material"
    ] = "plastic.physmat"  # NOT in the json from the geom cache, need to pull it from the sector
...
if __name__ == "__main__":
    ...
    CP77CollisionTriangleMeshJSONimport(
        sectorHashStr=sectorHashStrVal, entryHashStr=entryHashStrVal, project_raw_dir=project_raw_path
    )
