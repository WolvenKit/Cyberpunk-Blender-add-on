    ...
    def create(self, Data, Mat):
        ...
        if "DiffuseTexture" in Data:
            dImgNode = CreateShaderNodeTexImage(
                CurMat, self.BasePath + Data["DiffuseTexture"], -800, 500, "DiffuseTexture", self.image_format
            )
        ...
        if "RoughnessTexture" in Data:
            rImgNode = CreateShaderNodeTexImage(
                CurMat, self.BasePath + Data["RoughnessTexture"], -800, 100, "RoughnessTexture", self.image_format, True
            )
        ...
        if "MetalnessTexture" in Data:
            mImgNode = CreateShaderNodeTexImage(
                CurMat, self.BasePath + Data["MetalnessTexture"], -800, 200, "MetalnessTexture", self.image_format, True
            )
