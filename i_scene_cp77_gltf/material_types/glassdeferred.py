    ...
    def create(self, Data, Mat):
        ...
        if "Normal" in Data:
            nMap = CreateShaderNodeNormalMap(
                CurMat, self.BasePath + Data["Normal"], -200, -500, "Normal", self.image_format
            )
        ...
        if "MaskTexture" in Data:
            mImg = imageFromRelPath(
                Data["MaskTexture"], self.image_format, DepotPath=self.BasePath, ProjPath=self.ProjPath, isNormal=True
            )
