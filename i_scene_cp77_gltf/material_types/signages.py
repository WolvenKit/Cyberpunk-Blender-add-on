...
class Signages:
    ...
    def create(self, Data, Mat):
        ...
        if "ColorOneStart" in Data:
            ...
            dCol = CreateShaderNodeRGB(
                CurMat, {"Red": 255, "Green": 255, "Blue": 255, "Alpha": 255}, -800, 250, "ColorOneStart"
            )
        ...
        if "MainTexture" in Data:
            dImg = imageFromRelPath(
                Data["MainTexture"], self.image_format, DepotPath=self.BasePath, ProjPath=self.ProjPath
            )
