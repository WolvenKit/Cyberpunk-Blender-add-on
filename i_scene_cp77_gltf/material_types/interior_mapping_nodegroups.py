...
def andrew_willmotts_plane_interior_mapping_node_group():
    if "CP77_AW_Plane_Interior_Mapping" in bpy.data.node_groups.keys():
        ...
        if vers[0] < 4:
            ...
            andrew_willmotts_interior_mapping.outputs[0].min_value = -3.4028234663852886e38
            andrew_willmotts_interior_mapping.outputs[0].max_value = 3.4028234663852886e38
            ...
            output0.min_value = -3.4028234663852886e38
            output0.max_value = 3.4028234663852886e38
        ...
        andrew_willmotts_interior_mapping_inputs[0].min_value = -3.4028234663852886e38
        andrew_willmotts_interior_mapping_inputs[0].max_value = 3.4028234663852886e38
        ...
        AR_group_input = create_node(
            andrew_willmotts_interior_mapping.nodes, "NodeGroupInput", (-131.2041015625, 100.0)
        )
        AR_div = create_node(
            andrew_willmotts_interior_mapping.nodes, "ShaderNodeMath", (96.85089111328125, 100.0), operation="DIVIDE"
        )
        ...
        AddGI = create_node(andrew_willmotts_interior_mapping.nodes, "NodeGroupInput", (10.0, 10.0))
        AR_div2 = create_node(andrew_willmotts_interior_mapping.nodes, "ShaderNodeMath", (10, 10.0), operation="DIVIDE")
        AR_div2.inputs[0].default_value = -1
        AddCXYZ = create_node(andrew_willmotts_interior_mapping.nodes, "ShaderNodeCombineXYZ", (10.0, 10.0))
        AddCXYZ.inputs[0].default_value = -1.0
        AddCXYZ.inputs[1].default_value = -1.0
        AddCXYZ.inputs[2].default_value = -1.0
        MultAdd = create_node(
            andrew_willmotts_interior_mapping.nodes, "ShaderNodeMath", (10.0, 10), operation="MULTIPLY_ADD"
        )
        ...
        MultAdd.location = (7058.0, 1401.0)
        AddGI.location = (7080.0, 1490.0)
        AR_div2.location = (7245, 1490.0)
        AddCXYZ.location = (7429.0, 1490.0)
...
def flipbook_function_node_group():
    if "CP77_Flipbook_Function" in bpy.data.node_groups.keys():
        ...
        flipbook_function_inputs[0].min_value = -3.4028234663852886e38
        flipbook_function_inputs[0].max_value = 3.4028234663852886e38
        ...
        flipbook_function_inputs[1].max_value = 3.4028234663852886e38
        ...
        flipbook_function_inputs[2].max_value = 3.4028234663852886e38
        ...
        flipbook_function_inputs[3].max_value = 3.4028234663852886e38
        ...
        flipbook_function_inputs[4].max_value = 3.4028234663852886e38
        ...
        flipbook_function_inputs[5].max_value = 3.4028234663852886e38
        ...
        fbOut0.min_value = -3.4028234663852886e38
        fbOut0.max_value = 3.4028234663852886e38
